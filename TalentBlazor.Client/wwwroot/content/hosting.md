...
##  [/TalentBlazor.Client](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/TalentBlazor.Client)
...
## [/TalentBlazor](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/TalentBlazor)

The .NET 6 `/TalentBlazor` backend server is required for this App's dynamic functions including the Hello API on the home page
