...
[PrerenderTasks.cs](https://github.com/NetCoreTemplates/blazor-wasm/blob/main/TalentBlazor.Tests/PrerenderTasks.cs)
with the `prerender` Test category. The only configuration the tasks require is the location of the `ClientDir` WASM Project 
defined in [appsettings.json](https://github.com/NetCoreTemplates/blazor-wasm/blob/main/TalentBlazor.Tests/appsettings.json) 
...
```xml
<PropertyGroup>
    <TestsDir>$(MSBuildProjectDirectory)/../TalentBlazor.Tests</TestsDir>
</PropertyGroup>
...
[<Loading/>](https://github.com/NetCoreTemplates/blazor-wasm/blob/main/TalentBlazor.Client/Shared/Loading.razor) component
...
[Docs.razor](https://github.com/NetCoreTemplates/blazor-wasm/blob/main/TalentBlazor.Client/Pages/Docs.razor).
...
[content](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/TalentBlazor.Client/wwwroot/content)
directory and uses the same
[/TalentBlazor.Client/MarkdownUtils.cs](https://github.com/NetCoreTemplates/blazor-wasm/blob/main/TalentBlazor.Client/MarkdownUtils.cs)
implementation [Docs.razor](https://github.com/NetCoreTemplates/blazor-wasm/blob/main/TalentBlazor.Client/Pages/Docs.razor)
