...
public static class Css
{
    ...
    public const string ValidationMessage = "mt-2 text-danger text-sm";
    public static string InputText => CssUtils.Tailwind.Input("");
    public const string InputLabel = "block text-sm font-medium text-gray-700 dark:text-gray-300";
    public const string Checkbox = "h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500";
